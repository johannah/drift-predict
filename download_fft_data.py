...
#wget https://oceanofthings.darpa.mil/docs/Sample%20Data/challenge_1-day_sofar_20211108_day6JSON.json -P new_data/
#wget https://oceanofthings.darpa.mil/docs/Sample%20Data/challenge_1-day_sofar_20211105_day4JSON.json
